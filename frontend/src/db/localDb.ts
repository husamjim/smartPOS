...
export async function seedLocalDbIfEmpty() {
  ...
  await db.products.bulkAdd([
    ...
    { id: 'p_4', name_en: 'Double Beef Burger Combo', name_ar: 'كومبو دبل بيف برجر', sku: 'REST-DBB-02', barcode: '8811004', price: 35.0, cost: 12.0, unit: 'meal', type: 'piece', category: 'Restaurant', min_stock: 0, is_pharmaceutical: 0 },
    { id: 'p_5', name_en: 'Shawarma Wrap', name_ar: 'صاروخ شاورما دجاج', sku: 'REST-SW-01', barcode: '8811005', price: 12.0, cost: 4.5, unit: 'piece', type: 'piece', category: 'Restaurant', min_stock: 0, is_pharmaceutical: 0 },
    { id: 'p_6', name_en: 'Classic Margherita Pizza', name_ar: 'بيتزا مارغريتا كلاسيك', sku: 'REST-MP-03', barcode: '8811006', price: 28.0, cost: 9.0, unit: 'piece', type: 'piece', category: 'Restaurant', min_stock: 0, is_pharmaceutical: 0 },
